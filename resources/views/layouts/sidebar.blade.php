<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="{{ url('/home') }}"><i class="ion ion-monitor"></i> <span>Dashboard</span></a></li>
            ...
            <li class="active"><a href="{{ route('productsIn.index') }}"><i class="ion ion-log-in"></i> <span>Produk Masuk</span></a></li>
